...
export default function CreateProperty() {
  ...
  const handleDetectLocation = async () => {
    ...
    try {
      ...
      // Try getting the last known position first (very fast, works great in simulators)
      let location = await Location.getLastKnownPositionAsync({});

      // If last known position is not available, request the current position with a timeout
      if (!location) {
